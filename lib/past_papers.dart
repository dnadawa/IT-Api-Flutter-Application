...
class _PastPapersState extends State<PastPapers> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: new AppBar(
            ...
            centerTitle: true,
          elevation: 0,
            title: new Text("Past Papers", style: new TextStyle(fontWeight: FontWeight.bold),),
          bottom: TabBar(
...
class _SinhalaPapersState extends State<SinhalaPapers> {
  ...
  final CollectionReference collectionReference  = Firestore.instance.collection("past_papers");
...
class _EnglishPapersState extends State<EnglishPapers> {
  final CollectionReference collectionReference  = Firestore.instance.collection("past_papers_english");
  List<DocumentSnapshot> paperlist;
  StreamSubscription<QuerySnapshot> subscription;
